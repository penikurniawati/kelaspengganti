...
<!-- <body class="hold-transition login-page" style="background-image: url('/pengganti/gambar/ugm1.jpg'); background-attachment: fixed;"> -->
<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    <form class="login-form" action="<?php echo base_url() ?>signinR" method="POST" abineguid="659B7D7643724F588398E8628EAE19F9">
       <?php 
      ...
      <div class="form-group has-feedback">
        <input type="username" name="username_admin" class="form-control" placeholder="Username">
