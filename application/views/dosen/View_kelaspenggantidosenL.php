							...
							<div class="box box-primary">
								...
								<div class="box-body">
									...
									<table class="table table-bordered table-striped">
										<?php
										//ini untuk penentuan periode tanggal
										$tanggal_input = (empty($_POST['tanggal'])) ? date("Y-m-d") : $_POST['tanggal'] ;
																...
																<div class="row">
																	<div class="col-md-12">
																		<div class="form-group">
																			...
																			<?php 
																			$pertemuan = $this->JadwalDosenM->getPertemuan($kelas[0]->id_kelas,$tgl,$sesi);
																			if(!empty($pertemuan)){
