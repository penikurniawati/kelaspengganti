					...
					<div class="box-body">
						...
						<table id="jadwaladmin1" class="table table-bordered table-striped">
							...
							<?php
					           ...
					           if (!empty($tampilKelasDosen)) {
					            $no = 1;
					            foreach ($tampilKelasDosen as $record) {
					                  # code...
				            ...
				            ?>
				              <tr>
				                ...
				                <td><a href="<?php echo base_url() ?>detailKelasDosen/<?php echo $record->id; ?>"> <?php echo $record->namaKelas; ?></a></td>
