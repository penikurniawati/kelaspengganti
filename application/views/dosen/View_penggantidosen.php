        ...
        <div class="box">
          ...
          <div class="box-body" style="padding-top: 30px;">
            <table id="jadwaladmin1" class="table table-bordered table-striped">
              ...
              <tbody>
              <?php
                        if (!empty($tampilKelasKosongDosen)) {

                           $no = 1;
                          foreach ($tampilKelasKosongDosen as $record) {
                ...
                <tr>
                  ...
                  <td>
                    <a href="<?php echo base_url() ?>kelasPenggantiDosenPR/<?php echo $record->idJadwal ?>/<?php echo $record->tglPertemuan ?>/<?php echo $record->idPertemuan ?>" class="btn btn-edit" style="color: #3C8DBC" ><span data-toogle="tooltip" title="Buat Jadwal Pengganti"><i class="fa fa-retweet" ></i></span>
                    </a>
                  </td>
                </tr>
                <?php
